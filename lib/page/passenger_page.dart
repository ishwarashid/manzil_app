...
class _PassengerPageState extends State<PassengerPage> {
  ...
  void initState() {
    ...
    if(_userDB.userExists(getPhoneNumber()) != null && _userDB.userExists(getPhoneNumber()) != false) {
      return;
    }
                      ...
                      ElevatedButton(
                          onPressed: () {
                            if (_firstNameController.text.isEmpty &&
                              ...
                              Get.snackbar(
                                  "Empty Fields!", "Please enter your details",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          Center(child: Text("Welcome ${_firstNameController.text}")),
